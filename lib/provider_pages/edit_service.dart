...
class Edit_Service_Page extends StatefulWidget {
  static const String id="Edit_Service_Page";
  final Map<String, dynamic> data;
  Edit_Service_Page({Key? key,required this.data}) : super(key: key);

  @override
  State<Edit_Service_Page> createState() => _Edit_Service_PageState();
}

class _Edit_Service_PageState extends State<Edit_Service_Page> {
 ...
 selectedSubCategories = widget.data['sub_category'];
 getSubCategories();
 // image=widget.data['cover_image'];
 // image=File(widget.data['cover_image'])as File?;
 // selectedSubCategories=widget.data['category_data']['id'];
 ...
 // print("imageeee"+image.toString());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBar(context: context, title: 'Edit Service', appBarColor: MyColors.appbarcolor),
      body: Container(
              ...
              GestureDetector(
                onTap: ()async{
                  ...
                  if(subcategoriesTemp!=null){
                    ...
                    print("selectedSubCategories"+selectedSubCategories.toString());
                  }
                  setState(() {
      ...
      //                        },
      //                      ),
      //                      ParagraphText(text: '4 hours', fontSize: 13,)
      //                    ],
      //                  ),
      //                  Row(
      //                    children: [
