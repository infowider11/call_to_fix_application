...
class Add_Package_Page extends StatefulWidget {
  static const String id="Add_Package_Page";
  const Add_Package_Page({Key? key}) : super(key: key);

  @override
  State<Add_Package_Page> createState() => _Add_Package_PageState();
}

class _Add_Package_PageState extends State<Add_Package_Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBar(context: context, title: 'Add Package', appBarColor: MyColors.appbarcolor),
      body: Stack(
        children: [
          Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  vSizedBox2,
                  headingText(text: 'Package Fee', fontSize: 16, fontFamily: 'medium',),
                  vSizedBox,
                  CustomTextField(
                  ...
                  vSizedBox4,
                  RoundEdgedButton(text: 'Submit', textColor: Colors.white,
                    onTap: () async {
                      if (titleController.text == '') {
                        ...
                        showSnackbar(MyErrorConstants.invalidselectService);
                      }
