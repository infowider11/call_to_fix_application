...
class Service_detail extends StatefulWidget {
  ...
  const Service_detail({Key? key,this.service_id}) : super(key: key);
...
class _Service_detailState extends State<Service_detail> {
  ...
  get_info() async{
    ...
    http.Response response =
        await Webservices.getData(ApiUrls.serviceDetail + widget.service_id.toString());
    setState(() {
      load=false;
    });
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    vSizedBox2,
                    headingText(text: 'Subcategory', fontSize: 16,),
                      Container(
                        height: 100,
                        width: MediaQuery.of(context).size.width,
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: [
                            for(int i=0;i<service_info['sub_category'].length;i++)
                            Container(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child:Column(
                                      ...
                                      children: [
                                        CustomCircularImage(
                                          imageUrl: service_info['sub_category'][i]['cat_icon'],
                                          height: 24,
                                          width: 24,
                                          fileType: CustomFileType.network,
                                          fit: BoxFit.fitHeight,),
                                  ...
                                  SizedBox(height: 5,),
                                  ParagraphText(
                                    text: service_info['sub_category'][i]['title'],
                                    fontSize: 9,textAlign: TextAlign.center,
                                    color: Colors.black.withOpacity(0.70),
                                  )
                                ],
