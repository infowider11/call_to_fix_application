...
class Provider_list_page extends StatefulWidget {
  static const String id="Provider_list_page";
  final String? categoryId;
  final String? subCategoryId;
  final String? serviceType;
  const Provider_list_page({Key? key , this.categoryId,this.subCategoryId,this.serviceType}) : super(key: key);

  @override
  State<Provider_list_page> createState() => _Provider_list_pageState();
}

class _Provider_list_pageState extends State<Provider_list_page> {
  ...
  void initState() {
    ...
    print("onnnnnn"+widget.serviceType.toString());
    search();
    super.initState();
  }
  search()async{
...
"category_id":widget.categoryId,
 ...
 searchData=await Webservices.getMap(ApiUrls.searchUserServices,request: request);
 print("searchData"+searchData.toString());
    if(searchData!['status'].toString()=="1"){
      print("searchData"+searchData.toString());
    }
