...
class PaymentMethod_Page extends StatefulWidget {
  static const String id="PaymentMethod_Page";
  const PaymentMethod_Page({Key? key}) : super(key: key);

  @override
  State<PaymentMethod_Page> createState() => _PaymentMethod_PageState();
}

class _PaymentMethod_PageState extends State<PaymentMethod_Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBar(context: context, title: 'Select  Payment Method', appBarColor: MyColors.appbarcolor),
