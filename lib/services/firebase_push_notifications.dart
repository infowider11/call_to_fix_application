...
import '../pages/bookingInformationPage.dart';
...
Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  print('firebase notification baghhsid callled ');
    try{
      Map bookingInformation = await Webservices.getMap(ApiUrls.getBookingInformation + '?user_id=${userData!['id']}&user_type=${userData!['user_type']}&booking_id=${message.data['booking_id']}');
